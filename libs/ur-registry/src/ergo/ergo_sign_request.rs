    ...
    fn decode(d: &mut minicbor::Decoder<'b>, ctx: &mut C) -> Result<Self, minicbor::decode::Error> {
        ...
        cbor_map(d, &mut result, |key, obj, d| {
            ...
            match key {
                ...
                BOXES => {
                    cbor_array(d, &mut obj.boxes, |_key, obj, d| {
                        let tag = d.tag()?;
                        if !tag.eq(&Tag::Unassigned(
                            ErgoUnspentBox::get_registry_type().get_tag(),
                        )) {
                            return Result::Err(minicbor::decode::Error::message(
                                "ErgoUnspentBox tag is invalid",
                            ));
                        }
                        obj.push(ErgoUnspentBox::decode(d, ctx)?);
                        Ok(())
                    })?;
                }
                ORIGIN => {
...
mod tests {
    ...
    fn test_construct() {
        ...
        assert_eq!("", hex::encode(sign_request));
    }
}
