...
use crate::registry_types::{RegistryType, CRYPTO_ACCOUNT, CRYPTO_OUTPUT};
...
mod tests {
    ...
    fn test_encode() {
        ...
        let bytes =
            Vec::from_hex("02c6047f9441ed7d6d3045406e95c07cd85c778e4b8cef3ca7abac09b95c709ee5")
                .unwrap();
        ...
        let bytes =
            Vec::from_hex("022f01e5e15cca351daff3843fb70f3c2f0a1bdd05e5af888a67784ef3e10a2a01")
                .unwrap();
        let ec1 = CryptoECKey::new(None, None, bytes);
        let bytes =
            Vec::from_hex("03acd484e2f0c7f65309ad178a9f559abde09796974c57e714c35f110dfc27ccbe")
                .unwrap();
    ...
    fn test_decode() {
        ...
        assert_eq!(
            ...
            crypto.output_descriptors[0].get_script_expressions()
        );

        assert_eq!(
            "02c6047f9441ed7d6d3045406e95c07cd85c778e4b8cef3ca7abac09b95c709ee5",
            hex::encode(
                crypto.output_descriptors[0]
                    .get_ec_key()
                    .unwrap()
                    .get_data()
            )
        ...
        assert_eq!(
            ...
            crypto.output_descriptors[1].get_script_expressions()
        );

        assert_eq!(
            "03fff97bd5755eeea420453a14355235d382f6472f8568a18b2f057a1460297556",
            hex::encode(
                crypto.output_descriptors[1]
                    .get_ec_key()
                    .unwrap()
                    .get_data()
            )
        ...
        assert_eq!(
            vec![ScriptExpression::ScriptHash, ScriptExpression::MultiSig],
            crypto.output_descriptors[2].get_script_expressions()
        );
