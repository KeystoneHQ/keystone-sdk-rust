...
export! {
    ...
    fn parse_tron_signature(ur_type: &str, cbor_hex: &str) -> String {
        ...
        let parse_signature = || -> Result<(String, String), Error> {
            ...
            let keystone_sign_result = KeystoneSignResult::try_from(cbor).map_err(|_| format_err!(""))?;
            ...
            match content {
                Content::SignTxResult(sign_tx_result) => {
                    ...
                    Ok((request_id, sign_tx_result.raw_tx))
                },
                _ => Err(format_err!(""))
            }
        };
        match parse_signature() {
            Ok((request_id, raw)) => json!({
...
mod tests {
    ...
    fn test_parse_tron_signature() {
        ...
        let expect_result = "{\"raw\":\"\",\"request_id\":\"9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d\"}";
