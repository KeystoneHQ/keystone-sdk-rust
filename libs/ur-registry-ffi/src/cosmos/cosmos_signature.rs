...
mod tests {
    ...
    fn test_parse_cosmos_signature() {
        ...
        assert_eq!(expect_result, parse_cosmos_signature("cosmos-signature", signature_cbor));
    }
    ...
    fn test_parse_cosmos_signature_type_error() {
        ...
        assert_eq!(expect_result, parse_cosmos_signature("eth-signature", signature_cbor));
    }
