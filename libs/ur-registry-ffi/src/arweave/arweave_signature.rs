...
mod tests {
    ...
    fn test_parse_arweave_signature() {
        ...
        assert_eq!(expect_result, parse_arweave_signature("arweave-signature", arweave_signature_cbor));
    }
    ...
    fn test_parse_arweave_signature_type_error() {
        ...
        assert_eq!(expect_result, parse_arweave_signature("sol-signature", eth_signature_cbor));
    }
    ...
    fn test_parse_arweave_signature_error() {
        ...
        assert_eq!(expect_result, parse_arweave_signature("arweave-signature", eth_signature_cbor));
    }
}
