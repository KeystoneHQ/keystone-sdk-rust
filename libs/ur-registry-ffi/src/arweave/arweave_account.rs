...
mod tests {
    ...
    fn test_parse_arweave_account() {
        ...
        assert_eq!(expect_result, parse_arweave_account("arweave-crypto-account", eth_signature_cbor));
    }
    ...
    fn test_parse_arweave_account_type_error() {
        ...
        assert_eq!(expect_result, parse_arweave_account("sol-signature", eth_signature_cbor));
    }
