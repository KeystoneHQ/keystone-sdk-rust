...
mod tests {
    ...
    fn test_parse_extended_public_key() {
        ...
        assert_eq!(
            expect_result,
            parse_extended_public_key("crypto-hdkey", hd_key_cbor)
        );
    }
    ...
    fn test_get_source_hd_key_wrong_type() {
        ...
        assert_eq!(
            expect_result,
            parse_extended_public_key("crypto-account", hd_keys_cbor)
        );
    }
    ...
    fn test_parse_multi_public_keys() {
        ...
        assert_eq!(
            expect_result,
            parse_multi_public_keys("crypto-account", hd_keys_cbor)
        );
    }
    ...
    fn test_get_source_hd_keys_wrong_type() {
        ...
        assert_eq!(
            expect_result,
            parse_multi_public_keys("crypto-hdkey", hd_key_cbor)
        );
    }
