...
mod tests {
    ...
    fn test_parse_keystone_sign_result() {
        ...
        assert_eq!(expect_result, parse_keystone_sign_result("keystone-sign-result", keystone_sign_result_cbor));
    }
    ...
    fn test_parse_keystone_sign_result_type_error() {
        ...
        assert_eq!(expect_result, parse_keystone_sign_result("eth-signature", keystone_sign_result_cbor));
    }

    #[test]
    fn test_parse_keystone_sign_result_error() {
        let keystone_sign_result_cbor = "a1015901b11f8b08000000000000004d923d8e14300c85b5628b0121214db";
